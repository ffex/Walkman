...
@InputType()
class TodoItemCreateNestedManyWithoutTodoListsInput {
...
export { TodoItemCreateNestedManyWithoutTodoListsInput as TodoItemCreateNestedManyWithoutTodoListsInput };
